      ...
      <article className="min-h-screen">
        ...
        <section className="section-padding bg-white">
          <div className="container-max max-w-3xl prose prose-lg">
            <p>
              Bedrijfsuitjes. Ze kunnen geweldig zijn, maar ze kunnen ook heel saai zijn. Je gaat
              bowlen, je team staat vooral te wachten, iedereen gaat naar huis zonder echt iets
              gevoeld te hebben.
            </p>
            <p>
            ...
            <h2>Conclusie</h2>
            <p>
              Een goed bedrijfsuitje is er eentje waar je team echt iets voelt. Waar iedereen
              meedoet. Waar herinneringen ontstaan.
            </p>
            <p>
              Van deze 5 ideeën doet{' '}
              <Link
                href="/bedrijfsuitje-eindhoven"
                className="text-accent font-semibold hover:text-accent-dark"
              >
